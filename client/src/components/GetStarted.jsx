    ...
    const runSolver = async () => {
        ...
        try {
            const response = await fetch(
                "http://localhost:3001/api/run-solver",
                {
                    method: "POST",
                    headers: {
        ...
        >
            ...
            >
                ...
                <p className="text-lg text-gray-400 mb-12 text-center max-w-3xl mx-auto">
                    Run the CSP solver and visualize the generated timetable
                    with zero conflicts.
                </p>
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-6">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <button
                            ...
                            } text-white rounded-lg font-semibold transition-all duration-300 hover:scale-105 disabled:cursor-not-allowed`}
                        >
                    ...
                    <div className="bg-black rounded-lg p-4 font-mono text-sm text-green-400 h-64 overflow-y-auto">
                        {output ? (
                            ...
                            <div className="text-gray-600 text-center mt-20">
                                Click "Run Solver" to execute the C++ CSP
                                solver...
                            </div>
                        )}
                    </div>
                    ...
                    <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
                        <div className="flex gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="bg-gray-800 text-white px-4 py-2 rounded-lg border border-gray-700"
                                >
                                    {getGroupsForYear(selectedYear).map(
                                        (group) => (
                        ...
                        {sessions.length > 0 ? (
                                    ...
                                    <table className="w-full border-collapse">
                                        <thead>
                                            <tr className="bg-gray-800">
                                                <th className="border border-gray-700 p-3 text-white font-bold">
                                                    Time / Day
                                                </th>
                                                <th className="border border-gray-700 p-3 text-white font-bold">
                                                    Sunday
                                                                        ...
                                                                        {matchingSessions.map(
                                                                            (
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    className="bg-gradient-to-br from-green-600/20 to-blue-600/20 border border-green-500/30 rounded p-2 hover:border-green-500 transition-all"
                                                                                >
                                                                    ...
                                                                    {matchingSessions.map(
                                                                        (
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                className="bg-gradient-to-br from-purple-600/30 to-pink-600/30 border border-purple-500/50 rounded p-2 hover:border-purple-500 transition-all"
                                                                            >
                                                                                <div className="text-white font-bold text-sm">
                                                                                    {
                                                                                        session.code
                                                                                ...
                                                                                <div className="text-purple-300 text-xs mt-1 font-semibold">
                                                                                    Full
                                                                                    Day
                                                                                </div>
                                                                            </div>
                            ...
                            <div className="text-gray-600 text-center py-8">
                                No sessions found for Year {selectedYear} -{" "}
                                {selectedGroup}
                            </div>
                        )}
                    </div>
